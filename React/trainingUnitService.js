...
let getTrainingUnitById = (payload, id) => {
  const config = {
    method: "GET",
    url: `${endpoint}/${id}`,
    data: payload,
...
const addEditService = {addTrainingUnit, getTrainingUnitById, updateTrainingUnit, getTrainingUnitByOrgId, updateTrainingUnitStatus, getAllTrainingUnit,getPrimaryTrainerByCurrentUser};
