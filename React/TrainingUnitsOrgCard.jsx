...
function TrainingUnitsOrgCard(props) {
  ...
  const onViewDetailsClicked = () => {
    ...
    navigate(`/trainingunit/${props.trainingUnitData.id}/viewdetails`, {
      state: viewDetail,
    });
  };
  return (
        ...
        >
          ...
          <Card.Body className="text-wrap">
            <Card.Title className="text-white mb-3">
              Organization: {props.trainingUnitData.name}
            </Card.Title>
            <Card.Subtitle className="text-white mb-3">
              Training Status: {props.trainingUnitData.trainingStatusId.name}
            </Card.Subtitle>
            <Card.Subtitle className="text-white mb-3">
